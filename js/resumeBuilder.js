const bio = {
  ...
  welcomeMessage: "Hello World! I’m Michelle, a full stack web developer currently " +
      "in Portland, Oregon. Nothing excites me more than immersing myself in a good " +
      "challenge or a great book. When not coding, I am most likely spending my time " +
      "on some sort of creative project, getting involved in the local tech community, " +
      "or exploring the world around me with my trusty Nikon camera.",
  skills: [
    "HTML", "CSS(Sass)", "JavaScript", "jQuery", "Node.js", "Gulp.js",
    "Git", "Adobe Creative Suite", "Sketch", "Bootstrap", "Zurb Foundation",
    "Responsive Web Design", "Backbone.js", "Underscore.js", "Angular.js 2",
    "SQL", "PHP", "WordPress", "Photography", "Graphic Design", "Grunt.js",
    "Bash Scripting"
  ],
  ...
  display: function() {
    ...
    if (bio.contacts.blog) {
      contactsArray.push([HTMLblog, bio.contacts.blog]);
    }
    ...
    const mySkills = bio.skills;
    let formattedSkills = mySkills.forEach(function(skill) {
...
const education = {
  ...
  display: function() {
    ...
    const schoolEducation = education.schools;
    let formattedSchoolEducation = schoolEducation.map(function(school) {
      // Handles the possibility of multiple majors
      let listedMajors = "";
      if (school.majors.length > 1) {
        listedMajors = school.majors.join(", ");
      } else {
        listedMajors = school.majors.join("");
      }
      ...
      formattedSchool = HTMLschoolName.replace("%data%", school.name) +
        ...
        HTMLschoolMajor.replace("%data%", listedMajors);
    ...
    const onlineEducation = education.onlineCourses;
    let formattedOnlineEducation = onlineEducation.map(function(course) {
...
const work = {
  jobs: [{
      ...
      description: "Contract role where I built and designed features from wireframes " +
          "all the way through to creating the backend API. In this position I worked " +
          "with: HTML, CSS, Sass, JavaScript, jQuery, jQuery UI, Node.js, Hapi.js, " +
          "Joi.js, Git, GitHub, D3.js, Handlebars, API Design, MySQL, SVG Graphics, " +
          "Canvas, Graphic Design, UX Design, Amazon Lambda, Amazon AWS, Amazon SES, " +
          "and Amazon Cognito."
    },
    {
      ...
      description: "Recreated website from scratch using WordPress. In this position " +
      "I worked with: HTML, CSS, WordPress, PHP, Design, Maintenance, and Training."
    },
    {
      employer: "Biamp",
      ...
      "In this position I worked with: HTML, CSS, Sass, JavaScript, jQuery, " +
      "Backbone.js, Underscore.js, Gulp.js, and Scrum."
    },
    {
      employer: "Treehouse",
      ...
      description: "Collaborated with students in one-on-one video sessions to " +
      "help them learn how to solve problems and debug their code. In this position " +
      "I worked with: HTML, CSS, Sass, JavaScript, jQuery, APIs, Responsive Design, " +
      "Accessibility, SVG Graphics, HTML5 Video, Pair Programming, and Mentoring."
    },
    {
      ...
      description: "Worked directly with local and remote students to ensure the " +
      "mastery of languages across the stack as part of a software development " +
      "bootcamp. In this position I worked with: HTML, CSS, JavaScript, jQuery, " +
      "PHP, SQL, Python, Version Control, Git, GitHub, Visual Studio, Scrum, Agile, " +
    ...
    },
    {
      ...
      description: "Worked within a legacy system to perform updates to both the " +
          "content and the structure of various client websites. In this position I " +
          "worked with: HTML, CSS, JavaScript, jQuery, Subversion, Adobe Photoshop, " +
          "Adobe Illustrator, Adobe InDesign, Social Media Management, and SEO."
    }
  ],
  display: function() {
    const workExperience = work.jobs;
    workExperience.forEach(function(position) {
      let formattedPosition = HTMLworkEmployer.replace("%data%",
          position.employer) +
      ...
      $("#workExperience").append($(HTMLworkStart).append(
        formattedPosition));
    });
  }
};
...
const projects = {
  projects: [{
    ...
    },
    {
      ...
      dates: "June 2017",
      description: "Main portfolio site built using Node.js and Express.js. Pug " +
          "is used for templating and Scss for styling",
      images: ["images/portfolio-small.png",
        "images/portfolio-blog.png",
        "images/portfolio-coding-stats.png",
    ...
    },
    {
      ...
      dates: "2016 / 2017",
      description: "A travel blog created for someone who was about to spend a " +
          "year abroad. Built on WordPress.",
  ...
  display: function() {
    ...
    allProjects.forEach(function(project) {
      ...
      for (let i = 0; i < project.images.length; i++) {
        images = images + HTMLprojectImage.replace("%data%", project.images[
          i]);
      }
      let formattedProject = HTMLprojectTitle.replace("%data%", project
          .title).replace("#", project.url) +
